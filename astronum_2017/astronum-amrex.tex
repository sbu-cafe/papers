...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\linewidth]{ppsn-amr.png}
\begin{minipage}[b]{0.48\linewidth}
\caption{\label{fig:amr_grid} Colormap of density and the associated AMR 
grid structure in a pulsational pair-instability supernova simulation.  
Image courtesy of Ken Chen \cite{chen2014two}.}
\end{minipage}
\end{figure}
...
Figure~\ref{fig:castro-scaling} shows \castro\ scaling behavior for a pure
...
boxes that enable domain decomposition for parallelism.\MarginPar{unclear what the difference between a grid and box is here}
An iterator loops over all of the boxes at the same level of refinement and passes
