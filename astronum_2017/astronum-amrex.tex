...
model for SNe Ia~\cite{wdmergerI}. \MarginPar{There are others: Ma's
  Chandra model of SNe Ia; Lovegrove's shock breakout; Moll's WD
  merger; Moll's double det in subCh.} Recent work has focused on
...
\MarginPar{we should update this to a more modern processor---Don can you run
this on summitdev?}
