...
diffusion. \MarginPar{Remind the reader what this was/where they should be looking in the plot to see this temperature drop} As we'll see when the lower resolution case, we do not
...
\begin{deluxetable}{rL}
	...
	\tablehead{\colhead{resolution} & \colhead{error}}
	\startdata
	32  & 5.995\times 10^{-3} \\
        64  & 1.477\times 10^{-3} \\
       128  & 3.664\times 10^{-4} \\
