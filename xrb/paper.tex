...
\affiliation{Department of Astrophysical Sciences, Princeton University, Peyton Hall, Princeton, NJ 08544}
...
freely available in the \castro\ github repository\footnote{\url{https://github.com/AMReX-Astro/Castro}}.
...
Figure~\ref{fig:time_series} shows the time \MarginPar{this plot needs a description}
...
\MarginPar{talk about the low res run?}
