...
shallow-water approximation, so the vertical details of the atmosphere
...
incorporated via Strang splitting~\cite{strang:1968}, giving a method
that is overall second-order accurate in space and time.
\castro\ uses the \amrex\ adaptive mesh refinement
library~\cite{amrex_joss} to manage a hierarchy of grids at different
resolutions.
