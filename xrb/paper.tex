...
\MarginPar{Can we change the black grids to magenta? Black is hard to see against the dark red and black background.}
...
To measure the propagation \MarginPar{Can we rename this section "Flame Propagation"? The burning front in our simulations seems to move at a constant velocity, and we don't discuss acceleration.}
rate of the burning front, we first collapse our nuclear
...
inverse relation between rotation rate and the ratio of the burning front area to vertical area \citep{cavecchi:2013}.
