...
specified, $T_i = T(p_i, \rho_i, \{X_k\}_i)$ (in the neutron star, ramp,
and isothermal buffer layers) or constant entropy, $s_i = s(p_i, \rho_i,
...
We only ran the 10/10 simulation with the {\tt iso7} reaction network to 15~ms,
and we observe this was sufficient to establish its steady flame speed for comparison to our 10/10 simulation with the {\tt aprox13} network.
The reduced network size saves a lot of memory,
