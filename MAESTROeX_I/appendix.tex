...
\MarginPar{mention alt energy fix for projection?  also mention changes in $w_0$ computation for irregular base state. also add graphic of temperature falling due to incorrect splitting}
