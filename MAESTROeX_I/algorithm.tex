...
\item Compute the face-centered, time-centered species, $(\rho X_k)^{\nph,\pred}$,
  ...
  and here we spatially interpolate $(\rho_0^n+\rho_0^{n+1,*})/2$ to faces to assemble the fluxes.
...
\item Compute the face-centered, time-centered enthalpy, $(\rho h)^{\nph,\pred},$
  ...
  and here we spatially interpolate $[(\rho h)_0^n)+(\rho h)_0^{n+1,*}]/2$ to faces to assemble the fluxes.
