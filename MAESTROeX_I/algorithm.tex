...
\MarginPar{Should emphasize that velocity splitting is still done for projection steps, but full velocity is used to update advection and reactions. Also mention role of $\eta_{\rho}$ here(?)}
...
\MarginPar{Mention that velocity splitting is still done for projection steps in order to properly enforce boundary conditions}
