...
layer of constant altitude of a Cartesian grid variable onto a one-dimensional base state.
...
A potential benefit to eliminating the mapping error is to consider a spherical star in hydrostatic equlibrium at rest.
In the absense of reactions, the star should remain at rest.
