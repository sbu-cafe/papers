...
The code leverages the new AMReX framework for block-structured adaptive mesh refinement calculations allowing for improved scalability of the predecessor code.
We present a new, simplified temporal integration scheme that retains the same order of accuracy as our previous code.
