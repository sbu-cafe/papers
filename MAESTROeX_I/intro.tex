...
pressure-projection steps.  This, \MarginPar{is there a word missing before or after the 'This'?} the time step is limited by an advective CFL constraint based on the 
