...
Furthermore, the low Mach number model in MAESTRO is specifically designed for astrophysical settings with significant atmospheric stratification.
...
In Section \ref{eq:algorithm} we present our numerical algorithm in detail.
