...
\MarginPar{I didn't think we did Zenodo yet}
...
\MarginPar{should meriodional be meridional (throughout text)?}
...
%     \item GPUs in \maestroex: ported most of the source terms, working on the hydro. one-dimensional base state causing headaches, especially for big problems where we suspect it may not fit in GPU memory.
