...
This problem uses a simple reaction network modelling $^{12}\mathrm{C} + {}^{12}\mathrm{C} \rightarrow {}^{24}\mathrm{Mg}$ integrated on the GPUs using the CUDA Fortran port of VODE \citep{vode} described in \cite{Zingale2018}.
