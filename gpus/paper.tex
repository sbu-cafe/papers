\documentclass[preprint,times]{aastex62}
...
with the \castro\ multiphysics simulation code.  Similar to the approaches
of Kokkos and RAJA, we have implemented a mechanism for offloading compute
kernels to GPUs inside of the AMReX adaptive mesh refinement library.
Our goal is to have the same computational
