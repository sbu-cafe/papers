...
codes, including
\citet{gamer,cholla,fargo3d,pekkila:2017,caplan:2018,racz:2018,liska:2018,goz:2018,wang:2010,Padioleau2019,Bryan2014,Kulikov2014} \MarginPar{todo:
  group by AMR/no-AMR, GPU exclusive, Kokkos, ...}
...
\cite{timmes_swesty:2000} and the stellar conductivity described in
\cite{Timmes00}.  The science goal of the problem is to understand the
