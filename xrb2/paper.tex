...
at how the flame properties depends on the model parameters.  All
simulations are run in a domain $1.8432\times 10^5~\mathrm{cm} \times
3.072\times 10^4~\mathrm{cm}$ with a coarse grid of $1152 \times 192$
zones and 2 levels of refinment (the first a jump by a factor of $4$
and the second a jump by a factor of $2$ finer).  This gives a
