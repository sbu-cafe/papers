...
{\color{blue} Figure \ref{fig:streamlines} shows the velocity field. Not sure where we want to put 
this.}
...
{\color{blue} (see Figure \ref{fig:maxima})}, even at the latest timesteps ($\sim 70~\mathrm{ms}$, 
when the flame is most developed). {\color{blue} Significant $\enucdot$ values for all other runs 
are confined to the flame front, rather than spanning the entire domain}.
