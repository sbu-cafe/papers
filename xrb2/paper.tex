...
$Q(c_i)$ is the value of $Q$ in cell $c_i$ (with $m(c_i)$ being the total mass in cell $c_i$). Using $\repavg{Q}$ instead of simply taking the maximum of the quantity across the entire 
