...
gradient becomes important. It is approximately:
\begin{equation}
	\label{eqn:rossby}
...
neutron star rotation rate. Comparing Figure \ref{fig:time_series_enuc_500} and Figure 
\ref{fig:time_series_enuc_1000}, the horizontal extent of the $\tt{F1000}$ flame does appear to be 
...
which allows the reactions to progress further. In contrast to {\tt F500} and {\tt F1000}, the 
...
described by Equation \ref{eqn:rossby}. 
...
Coriolis confinement. We also observe that $\tt{F500}$ accelerates 
