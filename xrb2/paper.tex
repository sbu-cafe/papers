...
\ref{fig:time_series_enuc_1000} also support this interpretation, with the interior of the 
flame nearest to the crust in the {\tt F1000} run reaching higher $\dot{e}_\mathrm{nuc}$ values 
...
ignition is not achieved. In this scenario, another source of confinement (e.g.\ magnetic fields) 
