...
\begin{deluxetable}{lrrr}
	...
	datasets for times $t \gtrsim 20~\mathrm{ms}$.}
	\tablehead{\colhead{run} & \colhead{$v_0$ (cm s$^{-1}$)} & \colhead{$a$ (cm s$^{-2}$)}} 
	\startdata
...
at $t = 0$.} \MarginPar{KE: Outside of updating the data in the table, is there anything else we 
