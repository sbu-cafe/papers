...
In our latest set of runs, we explore a variety of initial rotation rate and temperature conditions for the flame. The initial conditions are given in Table \ref{table:500Hz_runs}. 
