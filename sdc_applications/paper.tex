...
density failing below zero during advection, the VODE integration
...
\subsection{SDC Method}

A second-order accurate time integration method using a simple
deferred correction strategy was shown in \citep{nonaka:2016}.  A
...
\begin{equation}
{\bf J} = \partial \Rb/\partial {\bf w } \partial {\bf w}/\partial \Uc
\end{equation}.
