...
Figure~\ref{fig:xrb} \MarginPar{Mike will update this}
...
Within the realm of compressible hydrodynamics, there are a number of other techniques that 
should be explored. 
smarter refinement with AMR + hydrostatic refinement
well-balanced method to allow ultralow resolution to slide along with the burning front
higher-order
This are all 
