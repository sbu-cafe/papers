...
\caption{\label{fig:xrb} Helium flame spreading across the surface of
  a neutron star.  Shown are temperature (top), the nuclear energy
  generation rate (second), the velocity out of the simulation plane
  (third) and the mean molecular weight of the ash (bottom).  The out
  of plane velocity contours indicate where the Coriolis force has
