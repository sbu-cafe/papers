...
scale are at most weakly coupled with each other. In the context of X-ray bursts, one possibility for
...
An example of coupling compressible and Low Mach models within the mesh
refinement framework used by our codes, but in a terrestrial context,
