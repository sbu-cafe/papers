...
flame physics. The flame proceed mainly via conduction, thus being a
...
propagations speed of order $10^5 $ km/s in good agreement with
...
\cite{art-2015-cavecchi-etal}. The NS systems exhibiting XRBs are
expected to have magnetic fields in the range $10^7 - 10^{10}$
G. Inclusion of a vertical magnetic field proved to have a strong
...
\caption{\label{fig:xrb} Helium flame spreading across the surface of
  ...
  leading to an inclined front. It is at such interface that the
