...
across the domain to setup a hot region at the left of our domain in
equilibrium with the cool model.  Thermal diffusion and nuclear
...
Figure~\ref{fig:xrb} shows the flame structure.  The top panel shows
the temperature.  The initial perturbation reached to $2\times
10^4~\mathrm{cm}$, so at this point, the extend of the burnt region
has nearly doubled.  The flame structure is quite wide
...
something as simple as subzone burning.  This is harder...
