...
different physical processes can cause the coupling to \replaced{breakdown}{break down, since the reactions do not see the effects of the hydrodynamics and vice versa}.
...
\replaced{a code}{the integration method---it may take more steps than allowed, require a timestep below floating point accuracy, or fail to meet the tolerenaces}.  The easiest way to improve the coupling is to cut the
...
means the hydro implicitly sees a time-centgered reactive source, making
