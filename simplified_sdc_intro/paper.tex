...
that does not give reliable results.  Instead, we compute $\partial {\bf w}/\partial {\bf U}^\prime$ analytically and $\partial {\bf R}/\partial {\bf w}$ numerically via one-sided differencing.
