...
shown in Figure~\ref{fig:subch_network}.
...
\begin{figure}
\centering
\plotone{strang_subch2_cfl0.8_state}
\caption{\label{fig:subch_strang_cfl08_I}}
\end{figure}

\begin{figure}
\centering
\plotone{strang_subch2_cfl0.8_mass_fractions}
...
\begin{figure}
\centering
\plotone{sdc_subch2_cfl0.8_state}
\caption{\label{fig:subch_sdc_cfl08_I}}
\end{figure}

\begin{figure}
\centering
\plotone{sdc_subch2_cfl0.8_mass_fractions}
...
For supernova calculations, we often want to know how much mass of
\isot{Ni}{56} was produced.  Table \ref{table:masses} shows the total
...
dominated by the cost of reactions.
