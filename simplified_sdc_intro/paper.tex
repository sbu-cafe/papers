...
\replaced{a code}{the integration method---it may take more steps than allowed by the ODE integrator, require a timestep below floating point accuracy, or fail to meet the tolerenaces}.  The easiest way to improve the coupling is to cut the
