...
Our reaction network includes the nuclei: $\mathrm{n}$,
${}^{1}\mathrm{H}$, ${}^{4}\mathrm{He}$, ${}^{12}\mathrm{C}$,
${}^{14}\mathrm{C}$, ${}^{13}\mathrm{N}$, ${}^{14}\mathrm{N}$,
${}^{16}\mathrm{O}$, ${}^{18}\mathrm{O}$, ${}^{18}\mathrm{F}$,
${}^{20}\mathrm{Ne}$, ${}^{21}\mathrm{Ne}$, ${}^{22}\mathrm{Ne}$,
${}^{22}\mathrm{Na}$, ${}^{23}\mathrm{Na}$, ${}^{23}\mathrm{Mg}$,
${}^{24}\mathrm{Mg}$, ${}^{27}\mathrm{Al}$, ${}^{27}\mathrm{Si}$,
${}^{28}\mathrm{Si}$, ${}^{31}\mathrm{P}$, ${}^{31}\mathrm{S}$,
${}^{32}\mathrm{S}$, ${}^{35}\mathrm{Cl}$, ${}^{36}\mathrm{Ar}$,
${}^{39}\mathrm{K}$, ${}^{40}\mathrm{Ca}$, ${}^{43}\mathrm{Sc}$,
${}^{44}\mathrm{Ti}$, ${}^{47}\mathrm{V}$, ${}^{48}\mathrm{Cr}$,
${}^{51}\mathrm{Mn}$, ${}^{52}\mathrm{Fe}$, ${}^{55}\mathrm{Co}$,
${}^{56}\mathrm{Ni}$.



The rates linking them are:
