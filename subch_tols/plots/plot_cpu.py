...
#    ("subch_sdc_cfl0.4/cpu_times.out", "SDC CFL=0.4", "C0", "+"),
    ("subch_sdc/cpu_times.out", "SDC CFL=0.2", "k", None),
    ]

strang_files = [
    ("subch_strang/cpu_times.out", "Strang CFL=0.2", "C0", "o"),
#    ("subch_strang_cfl0.1/cpu_times.out", "Strang CFL=0.1", "C1", "x"),
    ...
    ("subch_strang_cfl0.05/cpu_times.out", "Strang CFL=0.05", "C0", "+"),
    ("subch_strang_tol1e-6/cpu_times.out", "Strang CFL=0.2, tols=1.e-6", "C1", "^"),
    ("subch_strang_tol1.e-8/cpu_times.out", "Strang CFL=0.2, atol_spec=1.e-8", "C1", "x")]
