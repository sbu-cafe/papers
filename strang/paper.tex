...
\item Evolve $(X_k, T)$, but ``freeze'' the specific
...
\item Evolve $(X_k, T)$, calling the equation of state each time
...
vs.\ the coarse run resolution.  The slope of these lines is a
measure of the convergence rate~\citep{ORVV}.  Guidelines showing ideal first and
